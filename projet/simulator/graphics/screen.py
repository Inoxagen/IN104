...
class Screen:
    def __init__(self, screen_size, bg_color=(0, 0, 0), caption=None):
        ...
        # [LeftMouse, MiddleMouse, RightMouse, ScrollWheelUp, ScrollWheelDown,Left_Key,Right_Key,Up_Key,Down_Key]
        self._buttons = [False, False, False, False, False,False,False,False,False]
    ...
    def get_events(self):
        ...
        for event in events:
            ...
            elif event.type == pg.KEYDOWN: #On se déplace avec ZQSD
                if event.key == pg.K_z:
